...
namespace Apex::Primitives {
	...
	namespace detail 
	{
		static float cube_vertices[] = {
			// Left Face
			-0.5f, -0.5f,  0.5f,    0.f, 1.f,    -1.f,  0.f,  0.f,     0.f,  1.f,  0.f,     0.f,  0.f,  1.f,
			-0.5f,  0.5f,  0.5f,    1.f, 1.f,    -1.f,  0.f,  0.f,     0.f,  1.f,  0.f,     0.f,  0.f,  1.f,
			-0.5f,  0.5f, -0.5f,    1.f, 0.f,    -1.f,  0.f,  0.f,     0.f,  1.f,  0.f,     0.f,  0.f,  1.f,
			-0.5f,  0.5f, -0.5f,	1.f, 0.f,    -1.f,  0.f,  0.f,     0.f,  1.f,  0.f,     0.f,  0.f,  1.f,
			-0.5f, -0.5f, -0.5f,	0.f, 0.f,    -1.f,  0.f,  0.f,     0.f,  1.f,  0.f,     0.f,  0.f,  1.f,
			-0.5f, -0.5f,  0.5f,	0.f, 1.f,    -1.f,  0.f,  0.f,     0.f,  1.f,  0.f,     0.f,  0.f,  1.f,

			// Back Face
			-0.5f, -0.5f, -0.5f,    0.f, 1.f,     0.f,  0.f, -1.f,     0.f,  1.f,  0.f,    -1.f,  0.f,  0.f,
			-0.5f,  0.5f, -0.5f,    1.f, 1.f,     0.f,  0.f, -1.f,     0.f,  1.f,  0.f,    -1.f,  0.f,  0.f,
			 0.5f,  0.5f, -0.5f,    1.f, 0.f,     0.f,  0.f, -1.f,     0.f,  1.f,  0.f,    -1.f,  0.f,  0.f,
			 0.5f,  0.5f, -0.5f,	1.f, 0.f,     0.f,  0.f, -1.f,     0.f,  1.f,  0.f,    -1.f,  0.f,  0.f,
			 0.5f, -0.5f, -0.5f,	0.f, 0.f,     0.f,  0.f, -1.f,     0.f,  1.f,  0.f,    -1.f,  0.f,  0.f,
			-0.5f, -0.5f, -0.5f,	0.f, 1.f,     0.f,  0.f, -1.f,     0.f,  1.f,  0.f,    -1.f,  0.f,  0.f,
			...
			// Bottom Face
			-0.5f, -0.5f,  0.5f,    0.f, 1.f,     0.f, -1.f,  0.f,     0.f,  0.f, -1.f,    -1.f,  0.f,  0.f,
			-0.5f, -0.5f, -0.5f,    1.f, 1.f,     0.f, -1.f,  0.f,     0.f,  0.f, -1.f,    -1.f,  0.f,  0.f,
			 0.5f, -0.5f, -0.5f,    1.f, 0.f,     0.f, -1.f,  0.f,     0.f,  0.f, -1.f,    -1.f,  0.f,  0.f,
			 0.5f, -0.5f, -0.5f,	1.f, 0.f,     0.f, -1.f,  0.f,     0.f,  0.f, -1.f,    -1.f,  0.f,  0.f,
			 0.5f, -0.5f,  0.5f,	0.f, 0.f,     0.f, -1.f,  0.f,     0.f,  0.f, -1.f,    -1.f,  0.f,  0.f,
			-0.5f, -0.5f,  0.5f,	0.f, 1.f,     0.f, -1.f,  0.f,     0.f,  0.f, -1.f,    -1.f,  0.f,  0.f,
